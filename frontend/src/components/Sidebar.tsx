...
export type Page =
  ...
  | 'admin-users' | 'admin-agents' | 'admin-doc-types' | 'admin-audit' | 'admin-settings';
    ...
    >
      ...
      <div className="flex items-center justify-between h-14 px-3 border-b border-cp-border shrink-0">
        ...
        <button
          ...
          className="p-1 rounded hover:bg-white/5 text-cp-dim"
      ...
      {/* Footer */}
      <div className="border-t border-cp-border p-2 shrink-0">
        <button
          onClick={onLogout}
