    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-cp-border">
          ...
          <button onClick={onClose} className="p-1 text-cp-dim hover:text-cp-text rounded hover:bg-cp-purple/10">
            <X className="w-4 h-4" />
          </button>
        </div>
            ...
            <div className="space-y-4">
              ...
              {noFile.length > 0 && (
                <div>
                  ...
                  <div className="space-y-1">
                    {noFile.map((d) => (
                      <div key={d.id} className="text-sm px-3 py-1.5 rounded bg-cp-purple/5 text-cp-dim line-through">
                        {d.title}
                      </div>
                    ))}
                  </div>
